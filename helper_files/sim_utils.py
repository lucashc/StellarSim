...
def zip_to_bodylist(pos_list, vel_list, m_list, dark_matter=False):
    """Constructs a BodyList3 from iterables of positions, velocities and masses.
     Accepts native python & numpy objects"""
    bodies = [make_body(pos, vel, m, dark_matter=dark_matter) for pos, vel, m in zip(pos_list, vel_list, m_list)]
